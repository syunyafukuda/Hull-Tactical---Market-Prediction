...
def main() -> int:
    ...
    if args.m_calendar_col is None:
        ...
        if m_calendar_col == "":
            m_calendar_col = None
    # fall back to calendar_col when override omitted
    ...
    if calendar_col and calendar_col in X_all.columns and calendar_col in test_cols:
        pipeline_input_columns = feature_cols + [calendar_col]
    else:
        pipeline_input_columns = list(feature_cols)
