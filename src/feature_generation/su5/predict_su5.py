...
学習済みの ``artifacts/SU5/inference_bundle.pkl`` を読み込み、指定されたテストデータに
...
def parse_args(argv: Iterable[str] | None = None) -> argparse.Namespace:
	parser = argparse.ArgumentParser(description="Run inference with the SU5 pipeline bundle.")
	...
	parser.add_argument("--artifacts-dir", type=str, default="artifacts/SU5", help="Directory storing SU5 artifacts")
	...
	parser.add_argument("--out-parquet", type=str, default="artifacts/SU5/submission.parquet", help="Submission parquet output path")
	parser.add_argument("--out-csv", type=str, default="artifacts/SU5/submission.csv", help="Submission csv output path")
...
def main(argv: Iterable[str] | None = None) -> int:
	...
	if not bundle_path.exists():
		raise FileNotFoundError(f"inference bundle not found: {bundle_path}. Run train_su5.py first.")
