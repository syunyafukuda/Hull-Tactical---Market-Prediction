...
学習済みの ``artifacts/SU3/inference_bundle.pkl`` を読み込み、指定されたテストデータに
...
def parse_args(argv: Iterable[str] | None = None) -> argparse.Namespace:
	parser = argparse.ArgumentParser(description="Run inference with the SU3 pipeline bundle.")
	...
	parser.add_argument("--artifacts-dir", type=str, default="artifacts/SU3", help="Directory storing SU3 artifacts")
	...
	parser.add_argument("--out-parquet", type=str, default="artifacts/SU3/submission.parquet", help="Submission parquet output path")
	parser.add_argument("--out-csv", type=str, default="artifacts/SU3/submission.csv", help="Submission csv output path")
