...
学習済みの ``artifacts/su1/inference_bundle.pkl`` を読み込み、指定されたテストデータに
...
既存の ``tests/common/submit_harness.py`` から呼び出しやすいよう、ベースライン推論
スクリプトと近い CLI オプションを提供している。
"""
...
from src.feature_generation.su1.train_su1 import SU1FeatureAugmenter  # noqa: E402,F401
...
def parse_args(argv: Iterable[str] | None = None) -> argparse.Namespace:
	parser = argparse.ArgumentParser(description="Run inference with the SU1 pipeline bundle.")
	...
	parser.add_argument("--artifacts-dir", type=str, default="artifacts/SU1", help="Directory storing SU1 artifacts")
	...
	parser.add_argument("--out-parquet", type=str, default="artifacts/SU1/submission.parquet", help="Submission parquet output path")
	parser.add_argument("--out-csv", type=str, default="artifacts/SU1/submission.csv", help="Submission csv output path")
