"""Unit tests for CatBoost training script."""
...
from src.models.catboost.train_catboost import (  # noqa: E402
    _to_1d,
    parse_args,
)
...
class TestArgumentParsing:
    ...
    def test_default_args(self):
        ...
        assert args.out_dir == "artifacts/models/catboost"
        assert args.n_splits == 5
        assert args.gap == 0
        assert args.iterations == 600
        assert args.depth == 6
        assert args.learning_rate == 0.05
        assert args.l2_leaf_reg == 3.0
        assert args.random_strength == 1.0
        assert args.bagging_temperature == 1.0
        assert args.border_count == 254
    ...
    def test_custom_hyperparameters(self):
        ...
        assert args.l2_leaf_reg == 5.0
        assert args.random_strength == 2.0
    ...
    def test_catboost_specific_params(self):
        """Test CatBoost-specific parameters."""
        args = parse_args(
            [
                "--bagging-temperature",
                "0.5",
        ...
        assert args.bagging_temperature == 0.5
        assert args.border_count == 128
