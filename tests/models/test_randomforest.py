"""Unit tests for RandomForest training script."""
...
from src.models.randomforest.train_randomforest import (  # noqa: E402
    _to_1d,
    parse_args,
)
...
class TestArgumentParsing:
    ...
    def test_default_args(self):
        ...
        assert args.out_dir == "artifacts/models/randomforest"
    ...
    def test_custom_hyperparameters(self):
        ...
        assert args.min_samples_split == 20
        assert args.min_samples_leaf == 10
        assert args.max_features == 0.5
    ...
    def test_bootstrap_and_oob_flags(self):
        """Test bootstrap and OOB score flags."""
        # Default values
        args = parse_args([])
        assert args.bootstrap is True
        assert args.oob_score is True
...
class TestRandomForestSpecificFeatures:
    """Test RandomForest-specific features."""

    def test_hyperparameter_defaults(self):
        """Test that RandomForest-specific hyperparameters have correct defaults."""
        args = parse_args([])
        
        # Verify RandomForest-specific parameters
        assert args.n_estimators == 500
        assert args.max_depth == 15
        assert args.min_samples_split == 10
        assert args.min_samples_leaf == 5
    ...
    def test_max_features_range(self):
        """Test max_features parameter accepts various values."""
        # Test fraction
        args = parse_args(["--max-features", "0.5"])
        assert args.max_features == 0.5
        
        # Test another fraction
        args = parse_args(["--max-features", "0.8"])
